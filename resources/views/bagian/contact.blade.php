                ...
                <div class="left">
                    <div class="fields">
                        <form action="./email" method="post" class="contact_form" id="contact_form">
                            ...
                            @endif
                            @if (session('error'))
                            <div class="returnmessage" data-success="{{ session('error') }}"></div>
                            @endif
                            ...
                            <div class="first">
                                <ul>
                                    ...
                                    <li>
                                        <input id="from" name="from" type="email" placeholder="Your Email"
                                            autocomplete="off" value="{{ old('from') }}" required>
                                        @error('from')
                                        <small style="color: red">{{ $message }}</small>
                                        @enderror
                                    </li>
                                    ...
                                    <li>
                                        <input id="perusahaan" name="perusahaan" type="text" placeholder="Your Company"
                                            autocomplete="off" value="{{ old('perusahaan') }}" required>
                                        @error('perusahaan')
                                        <small style="color: red">{{ $message }}</small>
                                        @enderror
                                    </li>
                            ...
                            <div class="cavani_tm_button">
                                <a id="send_message" href="#"
                                    onclick="document.getElementById('contact_form').submit()">Send Message</a>
                            </div>
                    ...
                    <div class="map_wrap">
                        ...
                        <div class="mapouter">
                            <div class="gmap_canvas"><iframe width="100%" height="355" id="gmap_canvas"
                                ...
                                </style><a href="https://www.embedgooglemap.net">website google maps</a>
                                <style>
                                    .gmap_canvas {
                                        overflow: hidden;
